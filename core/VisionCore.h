...
public:
  ...
  inline const RobotConfig& rconfig() const { return *rconfig_; }
  inline RobotConfig& rconfig() { return *rconfig_; }
  ...
  PerfectLocalizationModule *perfect_localization_;
  ...
  std::unique_ptr<RobotConfig> rconfig_;
#endif
  TextLogger* textlog();
  ...
  Timer camtimer_; // make this public so localization can read it
