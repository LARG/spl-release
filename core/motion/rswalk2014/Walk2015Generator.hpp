...
#include <cmath>
#include "Generator.hpp" // Removed motion/generator -Josiah
#include "BodyModel.hpp" // Same - Josiah
#include "types/XYZ_Coord.hpp"
#include "types/ActionCommand.hpp"
#include "utils/Timer.hpp"
#include <motion/RSWalkParameters.h>

class Walk2015Generator : Generator {
   public:
   explicit Walk2015Generator();
   ~Walk2015Generator();
   ...
   bool isActive();
   bool isStanding();
   void setWalkEngineParameters(RSWalkParameters params);
