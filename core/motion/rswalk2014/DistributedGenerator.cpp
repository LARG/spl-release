...
bool DistributedGenerator::isLinedUp(){return ((WalkEnginePreProcessor*)bodyGenerators[Body::WALK])->isLinedUp() or ((WalkEnginePreProcessor*)bodyGenerators[Body::KICK])->isLinedUp();}
