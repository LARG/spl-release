...
bool ClippedGenerator::isLinedUp(){return ((DistributedGenerator*)generator)->isLinedUp();}
void ClippedGenerator::resetLinedUp(){((DistributedGenerator*)generator)->resetLinedUp();}
