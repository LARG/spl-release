...
GoalDetector::GoalDetector(DETECTOR_DECLARE_ARGS, ColorSegmenter& color_segmenter, BlobDetector& blob_detector, LineDetector& line_detector, HoughDetector& hough_detector) : 
  DETECTOR_INITIALIZE, color_segmenter_(color_segmenter), blob_detector_(blob_detector), line_detector_(line_detector), hough_detector_(hough_detector), color(c_YELLOW) {
    // White goals code
