...
const float FIELD_X = 8920;               // Rules: Item A
const float FIELD_Y = 5950;               // Rules: Item B
const float LINE_WIDTH = 52;              // Rules: Item C
const float PENALTY_MARK_SIZE = 106;      // Rules: Item D
const float PENALTY_X =  550;             // Rules: Item E
const float PENALTY_Y = 2150;             // Rules: Item F
const float PENALTY_MARK_DISTANCE = 1275; // Rules: Item G
const float CIRCLE_DIAMETER = 1450;       // Rules: Item H
const float BORDER_STRIP_WIDTH = 670;     // Rules: Item I

const float GOAL_Y = 1500;                // Rules: Goal inner width (Fig. 2)
const float GOAL_POST_WIDTH = 97;        // Rules: Post width (Fig. 2)
const float GOAL_X = 400;                 // Rules: Distance from endline to 
                                          // back of goal (Fig. 2)

const float GOAL_HEIGHT = 804;            // Rules: Height of the goal, to the
