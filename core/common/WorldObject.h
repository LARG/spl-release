...
ENUM(WorldObjectType,   // Types of objects
  ...
  WO_OPP_OUTER_PEN_LEFT_L,
  WO_OPP_OUTER_PEN_RIGHT_L,
  WO_OWN_OUTER_PEN_RIGHT_L,
  WO_OWN_OUTER_PEN_LEFT_L,
  ...
  WO_OPP_OUTER_PEN_LEFT_T,
  WO_OPP_OUTER_PEN_RIGHT_T,
  WO_OWN_OUTER_PEN_RIGHT_T,
  WO_OWN_OUTER_PEN_LEFT_T,
  ...
  WO_OPP_OUTER_PENALTY,
  WO_OWN_OUTER_PENALTY,
  ...
  WO_OUTER_PENALTY_TOP_OPP,
  WO_OUTER_PENALTY_TOP_OWN,
  WO_OUTER_PENALTY_BOTTOM_OPP,
  WO_OUTER_PENALTY_BOTTOM_OWN,
