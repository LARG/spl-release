...
void DCMWrapper::initCommands(const std::string &commandType, int numJoints)
{
...
void DCMWrapper::sendJointCommands(bool send, float time, float angles[NUM_JOINTS], int jointIndStart, int numJoints) {
  // if(send) {
