...
class DCMWrapper {
 ...
 private:
  ...
  void initCommands(const std::string &commandType, int numJoints);
  ...
  void sendJointCommands(bool send, float time, float angles[NUM_JOINTS], int jointIndStart, int numJoints);
